...
{
	/// <summary>
	/// Base class for RadioButtonList and CheckBoxList
	/// </summary>
	/// <typeparam name="T"></typeparam>
	public abstract class OptionElementList<T> : FormElementList<T> where T : OptionElementList<T>
	{
		protected OptionElementList(string tagName, string name, IModelMetadataAccessor accessor)
