...
namespace Maxfire.Skat.UnitTests
{
	public class GroenCheckBeregnerTester
	{
		...
		class TestableGroenCheckBeregner : GroenCheckBeregner
		{
			...
			protected override ValueTuple<decimal> GetTopskattegrundlag(ValueTuple<PersonligeBeloeb> indkomster, decimal bundfradrag, decimal positivNettoKapitalIndkomstGrundbeloeb)
			{
		...
		{
			private readonly Action<ValueTuple<PersonligeBeloeb>, decimal, decimal> _action;

			public MockableGroenCheckBeregner(ISkattelovRegistry skattelovRegistry, Action<ValueTuple<PersonligeBeloeb>, decimal, decimal> action) : base(skattelovRegistry)
			{
				_action = action;
			}
		...
		public void IngenAftrapning()
		{
			...
			var indkomster = new PersonligeBeloeb().ToTupleOfSize(1);
